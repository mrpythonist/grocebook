          ...
          <img
            ...
            src={`${
              suggestion.imageName
                ? `http://localhost:8080/server/routes/api/uploads/${suggestion.imageName}`
          ...
          <Container>
            <Row>
              ...
              <Col md="4" className="text-center d-none d-md-block">
                ...
                <span>Call us 0308-7293542</span>
              </Col>
              <Col xs="12" className="text-center d-block d-md-none">
                <i className="fa fa-phone" />
                <span> Need advice? Call us 0308-7293542</span>
              </Col>
            </Row>
          </Container>
        </div>
          ...
          <Row className="align-items-center top-header">
            ...
            >
              <div className="brand">
                ...
                <Link to="/">
                  <h1 className="logo">GroceBook</h1>
                </Link>
              </div>
            </Col>
            <Col
